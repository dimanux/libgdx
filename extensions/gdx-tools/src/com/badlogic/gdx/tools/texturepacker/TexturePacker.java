	...
	private void writePackFile (File outputDir, String scaledPackFileName, Array<Page> pages) throws IOException {
		...
		for (Page page : pages) {
			...
			for (Rect rect : page.outputRects) {
				...
				rectJson.addChild("y", new JsonValue(page.y + page.height - (rect.height - settings.paddingY) - rect.y));
				...
				for (Alias alias : aliases) {
					...
					aliasJson.addChild("y", new JsonValue(page.y + page.height - (aliasRect.height -settings.paddingY) - aliasRect.y));
